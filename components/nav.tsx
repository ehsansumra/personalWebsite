    ...
    return (
        <nav
            ...
            <div className="pl-5 pr-5 flex items-center justify-between w-navWidth ">
                <Link href="/"><div className="text-violet-300   hover:drop-shadow-dropViolet shadow-gray-300 cursor-pointer select-none text-lg ">ehsan <span className="sm:inline-block hidden">sumra</span></div></Link>
